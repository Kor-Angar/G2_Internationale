...
MOBNAME_BARBQ_SHEEP = "";
MOBNAME_BENCH = "";
MOBNAME_ANVIL = "Amboss";
MOBNAME_BUCKET = "Wasser-Eimer";
MOBNAME_FORGE = "Schmiede-Feuer";
...
MOBNAME_PAN = "Pfanne";
MOBNAME_REPAIR = "";
MOBNAME_WATERPIPE = "Wasserpfeife";
MOBNAME_SWITCH = "Schalter";
MOBNAME_ORE = "Erzklumpen";
MOBNAME_WINEMAKER = "";
MOBNAME_ORCDRUM = "";
MOBNAME_STOVE = "Herd";
...
MOBNAME_BIBLIOTHEK = "Bibliothek";
MOBNAME_VORRATSKAMMER = "Vorratskammer";
MOBNAME_SCHATZKAMMER = "Schatzkammer";
MOBNAME_IGARAZ = "Igaraz Truhe";
...
MOBNAME_GRAVE_01 = "Baron Heinrich von Stahl 551 - 589 'Er kam, sah, und starb'";
...
MOBNAME_GRAVE_09 = "unbekannter Soldat";
MOBNAME_GRAVE_10 = "Mighty Alien Dwarf 2894-3787 - 'This is all fake! Believe me...'";
MOBNAME_GRAVE_11 = "Theodor 220 - 310 - 'Sein Geist sei befreit'";
MOBNAME_GRAVE_12 = "Veranim Sadea 390 - 'Die Unterwelt war sein Belang'";
MOBNAME_GRAVE_13 = "Serano Ukara 234 - 298 'Der, der den Turm bewachte'";
MOBNAME_GRAVE_14 = "Victimo Sorn 456 - 512 'Erst der Phoenix stoppte ihn'";
//MOBNAME_GRAVE_15 = " +432 'Man nannte ihn Heristun, er kam vom Meer''";
//MOBNAME_GRAVE_16 = "Ernesto Ortoj 350 - 410 'Ich werde immer bei dir bleiben'";
MOBNAME_GRAVE_17 = "Arthag Amashrog 730 - 756";
MOBNAME_GRAVE_18 = "Iotar 721 - 762";
MOBNAME_GRAVE_19 = "Midos 757 - 759";
MOBNAME_GRAVE_20 = "Oskar Sorn 703 - 736";
MOBNAME_GRAVE_21 = "Marta Ukara 732 - 771";
MOBNAME_GRAVE_22 = "Wilfied Ukara 722 - 764";
MOBNAME_GRAVE_23 = "Viktorus Stahl 741 - 755";
MOBNAME_GRAVE_24 = "Seb 725 - 773";
MOBNAME_GRAVE_25 = "Unbekannt";
MOBNAME_GRAVE_26 = "Mart Mulgo 721 - 779";
MOBNAME_GRAVE_27 = "Zahra 713 - 752";
...
NAME_SPL_TeleportFarm = "Teleport zum Grossbauern";
NAME_SPL_TeleportXardas = "Teleport zu Xardas";
...
NAME_SPL_Firebolt = "Feuerpfeil";
NAME_SPL_Zap = "Blitz";
NAME_SPL_LightHeal = "Leichte Wunden heilen";
NAME_SPL_SummonGoblinSkeleton = "Goblin Skelett erschaffen";
NAME_SPL_Icebolt = "Eispfeil";
NAME_SPL_InstantFireball = "Feuerball";
NAME_SPL_SummonWolf = "Wolf rufen";
NAME_SPL_WINDFIST = "Windfaust";
NAME_SPL_Sleep = "Schlaf";
NAME_SPL_MediumHeal = "Mittlere Wunden heilen";
NAME_SPL_Firestorm = "Kleiner Feuersturm";
NAME_SPL_SummonSkeleton = "Skelett erschaffen";
NAME_SPL_Fear = "Angst";
NAME_SPL_IceCube = "Eisblock";
NAME_SPL_ChargeZap = "Kugelblitz";
NAME_SPL_LightningFlash = "Blitzschlag";
NAME_SPL_SummonGolem = "Golem erwecken";
NAME_SPL_DestroyUndead = "Untote vernichten";
...
NAME_SPL_BreathOfDeath = "Todeshauch";
NAME_SPL_MassDeath = "Todeswelle";
NAME_SPL_ArmyOfDarkness = "Armee der Finsternis";
NAME_SPL_Shrink = "Monster schrumpfen";
NAME_SPL_Charm = "Vergessen";
...
NAME_Ring = "Ring";
NAME_Amulett = "Amulett";
NAME_Trank = "Trank";
NAME_Rune = "Rune";
NAME_Spruchrolle = "Spruchrolle";
NAME_Currency = "Gold: ";
PRINT_Trade_Not_Enough_Gold = "Du hast nicht genug Gold um den Gegenstand zu kaufen.";
NAME_Value = "Wert:";
NAME_Mag_Circle = "Kreis:";
NAME_Manakosten = "Manakosten:";
NAME_ManakostenMax = "Manakosten (max.):";
...
NAME_Dam_Point = "Pfeilschaden";
NAME_Dam_Fire = "Feuerschaden";
NAME_Dam_Magic = "Magieschaden";
NAME_Dam_Fly = "Wirbelschaden";
NAME_Damage = "Schaden";
NAME_Damage_Max = "Schaden (max.)";
NAME_PerMana = " (pro Mana)";
NAME_DamagePerSec = "Schaden pro Sec.";
NAME_Prot_Edge = "Schutz vor Waffen:";
NAME_Prot_Point = "Schutz vor Pfeilen:";
NAME_Prot_Fire = "Schutz vor Feuer:";
...
PRINT_LearnLP = "Lernpunkte + ";
PRINT_LearnCircle_1 = "Lerne: 1. Kreis der Magie";
PRINT_LearnCircle_2 = "Lerne: 2. Kreis der Magie";
PRINT_LearnCircle_3 = "Lerne: 3. Kreis der Magie";
PRINT_LearnCircle_4 = "Lerne: 4. Kreis der Magie";
PRINT_LearnCircle_5 = "Lerne: 5. Kreis der Magie";
PRINT_LearnCircle_6 = "Lerne: 6. Kreis der Magie";
PRINT_Learn1H = "Verbessere: Kampf mit Einhandwaffen";
PRINT_Learn1H_and_2H = "Verbessere: Kampf mit Einhand- und Zweihandwaffen";
PRINT_Learn2H = "Verbessere: Kampf mit Zweihandwaffen";
PRINT_Learn2H_and_1H = "Verbessere: Kampf mit Zweihand- und Einhandwaffen";
PRINT_LearnBow = "Verbessere: Treffen mit Bogen";
...
PRINT_LearnSmith = "Lerne: Waffe schmieden";
PRINT_LearnRunes = "Lerne: Rune erschaffen";
PRINT_LearnAlchemy = "Lerne: Trank brauen";
PRINT_LearnAlchemyInnosEye = "Lerne: Auge Innos aufladen";
...
PRINT_LearnMANA5 = "Mana + 5";
PRINT_Learn1h1 = "Einhand - Waffen + 1";
PRINT_Learn1h5 = "Einhand - Waffen + 5";
PRINT_Learn2h1 = "Zweihand - Waffen + 1";
PRINT_Learn2h5 = "Zweihand - Waffen + 5";
PRINT_LearnBow1 = "Bogen + 1";
PRINT_LearnBow5 = "Bogen + 5";
...
PRINT_AlchemySuccessInnoseye = "Das Auge Innos pulsiert voller Energie!";
...
PRINT_Smith_2H_Special_02 = " (3 Erz)";
PRINT_Smith_1H_Special_03 = " (3 Erz)";
PRINT_Smith_2H_Special_03 = " (4 Erz)";
PRINT_Smith_1H_Special_04 = " (4 Erz, 5 Drachenblut)";
PRINT_Smith_2H_Special_04 = " (5 Erz, 5 Drachenblut)";
NAME_MageScroll = "Spruchrolle";
PRINT_FoundRing = "Ring gefunden";
PRINT_FoundAmulett = "Amulett gefunden";
PRINT_FoundScroll = "Spruchrolle gefunden";
PRINT_FoundPotion = "Trank gefunden";
PRINT_FoundGold10 = "10 Gold gefunden";
PRINT_FoundGold25 = "25 Gold gefunden";
PRINT_FoundGold50 = "50 Gold gefunden";
PRINT_FoundGold100 = "100 Gold gefunden";
...
PRINT_XPGained = "Erfahrung + ";
PRINT_LevelUp = "Stufe gestiegen!";
PRINT_NewLogEntry = "Neuer Tagebucheintrag";
PRINT_TeleportTooFarAway = "Zu weit entfernt";
PRINT_BiffsAnteil = "Biffs Anteil: ";
PRINT_BiffGold = " Gold";
...
KapWechsel_4_Text = "Drachenjagd";
KapWechsel_5 = "Kapitel 5";
KapWechsel_5_Text = "Aufbruch";
KapWechsel_6 = "Kapitel 6";
KapWechsel_6_Text = "Die Hallen von Irdorath";
