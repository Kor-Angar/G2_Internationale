...
func void dia_ritter_out_info()
{
        ...
        {
                B_AI_Output(self,other,"DIA_Ritter_OUT_06_00");   //Ты пришел из Хориниса, да? Когда все кончится, я тоже вернусь туда.
                DIA_RITTER_OUT_NOPERM = TRUE;
        };
        if(hero.guild == GIL_KDF)
        {
                B_AI_Output(self,other,"DIA_Ritter_OUT_06_01");   //Я очень рад, что мы с вами в одной команде, сэр.
        }
        else
        {
                B_AI_Output(self,other,"DIA_Ritter_OUT_06_02");   //У нас получится. Мы доставим руду в Хоринис, и нас будут носить на руках!
        };
};
