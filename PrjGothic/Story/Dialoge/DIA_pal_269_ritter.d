...
{
        B_AI_Output(self,other,"DIA_Ritter_HERO_04_00");  //“вое по€вление здесь хороший знак дл€ нас всех. ћы все воспр€ли духом.
        if(DIA_RITTER_HERO_NOPERM == FALSE)
        {
                B_AI_Output(self,other,"DIA_Ritter_HERO_04_01");  //ћы знаем, что наши товарищи в городе не забыли о нас. √лаз »нноса наблюдает за всеми нами.
                B_AI_Output(self,other,"DIA_Ritter_HERO_04_02");  //» если орки и драконы будут ломитьс€ в ворота, мы встретим их с подн€тым забралом и будем сражатьс€ до победы или смерти.
