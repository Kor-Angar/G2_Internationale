...
{
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_FirstWarn_12_00");      //СТОЙ!
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_FirstWarn_12_01");      //Сюда вход запрещен!
...
{
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_SecondWarn_12_00");     //Ты что, оглох? Еще один шаг, и я порублю тебя в капусту!
        other.aivar[AIV_LASTDISTTOWP] = Npc_GetDistToWP(other,MIL_325_CHECKPOINT);
...
func void dia_mil_325_miliz_attack_info()
{
        ...
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_Attack_12_00"); //Это была твоя ошибка!
        AI_StopProcessInfos(self);
...
{
        B_AI_Output(other,self,"DIA_Mil_325_Miliz_Pass_15_00");   //Я состою в королевской армии. Я хочу взять снаряжение!
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_Pass_12_01");   //У тебя есть разрешение на это?
        Info_ClearChoices(dia_mil_325_miliz_pass);
        Info_AddChoice(dia_mil_325_miliz_pass,dia_mil_325_miliz_pass_no_description,dia_mil_325_miliz_pass_no); // "Нет."
        Info_AddChoice(dia_mil_325_miliz_pass,dia_mil_325_miliz_pass_yes_description,dia_mil_325_miliz_pass_yes); // "Конечно."
};
func void dia_mil_325_miliz_pass_yes()
{
        B_AI_Output(other,self,"DIA_Mil_325_Miliz_Pass_Yes_15_00");       //Конечно.
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_Pass_Yes_12_01");       //Хорошо, ты можешь войти!
...
{
        B_AI_Output(other,self,"DIA_Mil_325_Miliz_Pass_No_15_00");        //Нет.
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_Pass_No_12_01");        //Тогда убирайся отсюда.
        Info_ClearChoices(dia_mil_325_miliz_pass);
        AI_StopProcessInfos(self);
};
...
{
        B_AI_Output(other,self,"DIA_Mil_325_Miliz_PERM_15_00");   //Почему никому нельзя входить на этот склад?
        B_AI_Output(self,other,"DIA_Mil_325_Miliz_PERM_12_01");   //Достопочтенный лорд Хаген хранит здесь товары, конфискованные для королевской армии.
};
