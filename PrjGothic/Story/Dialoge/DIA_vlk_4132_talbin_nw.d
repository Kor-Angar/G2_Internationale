...
{
        B_AI_Output(other,self,"DIA_Talbin_NW_15_00");    //Этот Проход был не таким уж и страшным, правда?
        B_AI_Output(self,other,"DIA_Talbin_NW_07_01");    //Спасибо, что спас меня.
        B_AI_Output(self,other,"DIA_Talbin_NW_07_02");    //Вот. Я нашел этот камень в Проходе. Я думаю, он пригодится тебе.
        if(hero.guild == GIL_KDF)
        {
                B_AI_Output(self,other,"DIA_Talbin_NW_07_03");    //Мне кажется, это рунный камень.
                CreateInvItems(self,itmi_runeblank,1);
                b_giveinvitems(self,other,itmi_runeblank,1);
        }
        else
        {
                B_AI_Output(self,other,"DIA_Talbin_NW_07_04");    //Мне кажется, это кусок руды.
                CreateInvItems(self,itmi_nugget,1);
                b_giveinvitems(self,other,itmi_nugget,1);
        };
        B_AI_Output(self,other,"DIA_Talbin_NW_07_05");    //Да защитит тебя Иннос.
        AI_StopProcessInfos(self);
...
{
        B_AI_Output(other,self,"DIA_Talbin_NW_PERM_15_00");       //Все в порядке?
        B_AI_Output(self,other,"DIA_Talbin_NW_PERM_07_01");       //Да, спасибо тебе. А теперь иди. Со мной будет все в порядке.
        AI_StopProcessInfos(self);
};
