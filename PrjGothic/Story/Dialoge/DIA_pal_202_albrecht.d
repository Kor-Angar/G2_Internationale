...
{
        B_AI_Output(other,self,"DIA_Albrecht_Hagen_15_00");       //ћне нужно поговорить с лордом ’агеном!
        B_AI_Output(self,other,"DIA_Albrecht_Hagen_03_01");       //ќн в главном зале, иди пр€мо, не ошибешьс€.
        B_AI_Output(self,other,"DIA_Albrecht_Hagen_03_02");       //Ќе знаю, что тебе нужно от него, но будь краток - он зан€той человек!
};
...
{
        B_AI_Output(other,self,"DIA_Albrecht_Hallo_15_00");       // аково это, быть паладином?
        B_AI_Output(self,other,"DIA_Albrecht_Hallo_03_01");       //ѕаладины - воины »нноса. ќни живут ради того, чтобы служить ему, и сражаютс€ в его честь.
        B_AI_Output(self,other,"DIA_Albrecht_Hallo_03_02");       //¬замен все мы наделены даром магии. ћагии рун, которые даруютс€ в знак признани€ наших заслуг.
};
...
{
        B_AI_Output(other,self,"DIA_Albrecht_CanTeach_15_00");    //“ы можешь научить мен€ чему-нибудь?
        if(other.guild == GIL_PAL)
        {
                B_AI_Output(self,other,"DIA_Albrecht_CanTeach_03_01");    //≈сли ты докажешь, что достоин этого, € награжу теб€ магическими рунами паладинов.
                B_AI_Output(self,other,"DIA_Albrecht_CanTeach_03_02");    // роме того, € могу научить теб€, как повысить свои магические способности.
                ALBRECHT_TEACHMANA = TRUE;
                b_logentry(TOPIC_CITYTEACHER,TOPIC_CITYTEACHER_description_327); // "ѕаладин јльбрехт может помочь мне повысить мои магические способности."
        }
        else
        {
                B_AI_Output(self,other,"DIA_Albrecht_CanTeach_03_03");    //я обучаю только паладинов.
        };
};
...
{
        B_AI_Output(other,self,"DIA_Albrecht_TEACHPalRunes_15_00");       //я достоин получить руну?
        if(PLAYER_TALENT_RUNES[SPL_PALLIGHT] == FALSE)
        {
                B_AI_Output(self,other,"DIA_Albrecht_TEACHPalRunes_03_01");       //¬ знак признани€ твоего ранга € награждаю теб€ –уной —вета. Ёто символ истины и правосуди€.
                B_AI_Output(self,other,"DIA_Albrecht_TEACHPalRunes_03_02");       //ќсвещай путь тем, кто следует пути »нноса.
                B_AI_Output(self,other,"DIA_Albrecht_TEACHPalRunes_03_03");       //ќстальные руны ты должен заслужить. ѕриходи, когда сочтешь, что достоин их.
        ...
        {
                B_AI_Output(self,other,"DIA_Albrecht_TEACHPalRunes_03_04");       // акой путь ты выбираешь?
                B_AI_Output(self,other,"DIA_Albrecht_TEACHPalRunes_03_05");       //ѕуть исцелени€ или путь битвы?
                ...
                Info_AddChoice(dia_albrecht_teachpalrunes,dia_albrecht_teachpalrunes_heal_description,dia_albrecht_teachpalrunes_heal); // "я выбираю путь исцелени€."
                Info_AddChoice(dia_albrecht_teachpalrunes,dia_albrecht_teachpalrunes_combat_description,dia_albrecht_teachpalrunes_combat); // "я выбираю путь битвы."
        };
};
...
{
        B_AI_Output(self,other,"B_Albrecht_YouAreNotWorthy_03_00");       //“ы пока недостоин получить следующее заклинание этого пути.
};
func void dia_albrecht_teachpalrunes_heal()
{
        B_AI_Output(other,self,"DIA_Albrecht_TEACHPalRunes_Heal_15_00");  //я выбираю путь исцелени€.
...
{
        B_AI_Output(other,self,"DIA_Albrecht_TEACHPalRunes_Combat_15_00");        //я выбираю путь битвы.
...
{
        B_AI_Output(other,self,"DIA_Albrecht_Teach_15_00");       //я хочу повысить свои магические способности.
...
func void dia_albrecht_teach_back()
{
        ...
        {
                B_AI_Output(self,other,"DIA_Albrecht_Teach_03_00");       //≈сли ты хочешь повысить свои магические способности еще больше, тебе придетс€ поискать другого учител€.
        };
        Info_ClearChoices(dia_albrecht_teach);
};
