...
{
        B_AI_Output(other,self,"DIA_1052_Wegelagerer_Hello_15_00");       //Кто ты?
        B_AI_Output(self,other,"DIA_1052_Wegelagerer_Hello_06_01");       //Что это? Допрос?
        B_AI_Output(self,other,"DIA_1052_Wegelagerer_Hello_06_02");       //Мне нечего сказать тебе, но ты, возможно, захочешь поговорить с моим приятелем.
        B_AI_Output(self,other,"DIA_1052_Wegelagerer_Hello_06_03");       //Но будь осторожен, он не любит чужаков.
};
...
{
        B_AI_Output(self,other,"DIA_Wegelagerer_ANGRIFF2_06_00"); //Ладно, приятель. Сейчас ты получишь.
        AI_StopProcessInfos(self);
