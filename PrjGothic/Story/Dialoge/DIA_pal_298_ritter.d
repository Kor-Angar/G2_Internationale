...
{
        B_AI_Output(other,self,"DIA_PAL_298_Pass_15_00"); //Куда ведет эта дорога?
        B_AI_Output(self,other,"DIA_PAL_298_Pass_09_01"); //За этими воротами лежит проход в Долину Рудников.
        B_AI_Output(self,other,"DIA_PAL_298_Pass_09_02"); //На этой стороне мы, а на другой орки.
        B_AI_Output(self,other,"DIA_PAL_298_Pass_09_03"); //Лучше бы тебе повернуть назад - ты не сможешь пробиться туда.
};
...
{
        B_AI_Output(self,other,"DIA_PAL_298_TRESPASS_09_00");     //Ты уверен, что хочешь пойти туда? Боюсь, далеко ты не уйдешь - там орки.
        B_AI_Output(other,self,"DIA_PAL_298_TRESPASS_15_01");     //Если есть путь в Долину Рудников, Я найду его.
        B_AI_Output(self,other,"DIA_PAL_298_TRESPASS_09_02");     //Хорошо, тогда иди. Иди с Инносом.
};
...
{
        B_AI_Output(other,self,"DIA_PAL_298_Perm1_15_00");        //А что если я все же пойду, на свой страх и риск?
        B_AI_Output(self,other,"DIA_PAL_298_Perm1_09_01");        //Тогда ты погибнешь. Вот почему мы здесь. Чтобы у тебя не возникали такие идиотские идеи.
};
...
{
        B_AI_Output(other,self,"DIA_PAL_298_Perm2_15_00");        //Как обстановка?
        B_AI_Output(self,other,"DIA_PAL_298_Perm2_09_01");        //Все спокойно. Мы держим ситуацию под контролем.
};
