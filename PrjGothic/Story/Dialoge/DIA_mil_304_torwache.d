...
{
        B_AI_Output(other,self,"DIA_Mil_304_Torwache_WASMACHSTDU_15_00"); //Как дела?
        if((hero.guild == GIL_PAL) || (hero.guild == GIL_KDF))
        {
                B_AI_Output(self,other,"DIA_Mil_304_Torwache_WASMACHSTDU_08_01"); //Мне не на что жаловаться. Я выполняю свои обязанности, как того желает Иннос.
        }
        else
        {
                B_AI_Output(self,other,"DIA_Mil_304_Torwache_WASMACHSTDU_08_02"); //Эй, хватит нести чушь вроде 'как поживаешь'. Убирайся с глаз моих, понятно?
        };
        AI_StopProcessInfos(self);
};
