...
func void dia_bridgedementor_info()
{
        ...
        B_AI_Output(self,other,"DIA_BridgeDementor_19_00");       //Мы знали, что ты придешь!
        B_AI_Output(self,other,"DIA_BridgeDementor_19_01");       //Мой Хозяин одержит победу и склонит весь мир к своим ногам.
        B_AI_Output(self,other,"DIA_BridgeDementor_19_02");       //Ты наивный идиот! Ты понятия не имеешь, на что ты замахнулся, и я накажу тебя за это здесь и сейчас!
        Npc_SetRefuseTalk(self,30);
};
