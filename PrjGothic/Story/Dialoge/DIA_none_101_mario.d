...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_Job_15_00");   //Что ты делаешь здесь?
        B_AI_Output(self,other,"DIA_None_101_Mario_Job_07_01");   //Надеюсь, скоро придет какой-нибудь корабль, и я наймусь на него.
        B_AI_Output(self,other,"DIA_None_101_Mario_Job_07_02");   //Это шатание без дела уже действует мне на нервы.
};
...
{
        B_AI_Output(self,other,"DIA_None_101_Mario_YouNeedMe_07_00");     //Я слышал, что ты набираешь команду на свой корабль?
        B_AI_Output(other,self,"DIA_None_101_Mario_YouNeedMe_15_01");     //И?
        B_AI_Output(self,other,"DIA_None_101_Mario_YouNeedMe_07_02");     //Я готов!
        Log_CreateTopic(TOPIC_CREW,LOG_MISSION);
        Log_SetTopicStatus(TOPIC_CREW,LOG_RUNNING);
        b_logentry(TOPIC_CREW,TOPIC_CREW_description_284); // "Марио бывший моряк заговорил со мной в портовой таверне. Он хочет плыть на корабле."
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_WhyNeedYou_15_00");    //Почему я должен брать тебя?
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyNeedYou_07_01");    //Это просто. Потому что я нужен тебе.
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyNeedYou_07_02");    //Я... я был лейтенантом в королевском флоте.
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyNeedYou_07_03");    //Я служил моряком на 'Короле Робаре' и 'Гордости Миртаны'.
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyNeedYou_07_04");    //В битве у восточного архипелага я собственноручно отправил пару десятков орков назад в царство Белиара.
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyNeedYou_07_05");    //К сожалению, нас осталось слишком мало, когда наш флагман затонул и нам пришлось отступить.
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_WhyHere_15_00");       //А что ты делаешь здесь?
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyHere_07_01");       //Флоту пришлось бежать, и мы лишились жалования.
        B_AI_Output(self,other,"DIA_None_101_Mario_WhyHere_07_02");       //После моего списания на берег я застрял в этой дыре, и вот теперь ищу новое судно.
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_Abilities_15_00");     //Что ты можешь делать?
        B_AI_Output(self,other,"DIA_None_101_Mario_Abilities_07_01");     //Я обучен абордажу и ближнему бою, к тому же я метко стреляю из корабельной пушки.
        B_AI_Output(self,other,"DIA_None_101_Mario_Abilities_07_02");     //Я уверен, что я смогу обучить тебя чему-нибудь во время путешествия.
        b_logentry(TOPIC_CREW,TOPIC_CREW_description_285); // "Марио похоже собаку съел в том что касается морских боев. Возможно он сможет научить меня кое-чему."
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_YourPrice_15_00");     //Что ты за это хочешь?
        B_AI_Output(self,other,"DIA_None_101_Mario_YourPrice_07_01");     //Что я хочу? Да я буду рад просто убраться отсюда.
        B_AI_Output(self,other,"DIA_None_101_Mario_YourPrice_07_02");     //Я помогу тебе, а ты поможешь мне выбраться из этой дыры.
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_CouldBeDangerous_15_00");      //Путешествие может быть опасным.
        B_AI_Output(self,other,"DIA_None_101_Mario_CouldBeDangerous_07_01");      //Я привык к опасности. Когда ты вдали от дома, каждый день для тебя полон опасностей.
        B_AI_Output(self,other,"DIA_None_101_Mario_CouldBeDangerous_07_02");      //Любой шторм может стать для тебя последним, а монстры с глубин могут проглотить твой корабль целиком.
        B_AI_Output(self,other,"DIA_None_101_Mario_CouldBeDangerous_07_03");      //Не говоря уже о галерах орков. Поверь мне, я ничего не боюсь. Матрос, который боится, обречен на гибель.
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_DontNeedYou_15_00");   //Ты не нужен мне.
        B_AI_Output(self,other,"DIA_None_101_Mario_DontNeedYou_07_01");   //Я лучший матрос, которого можно найти здесь.
        B_AI_Output(self,other,"DIA_None_101_Mario_DontNeedYou_07_02");   //Мне кажется, ты не очень-то разбираешься в навигации.
        B_AI_Output(self,other,"DIA_None_101_Mario_DontNeedYou_07_03");   //Так что дважды подумай, прежде чем доверяться кому-нибудь.
};
...
{
        B_AI_Output(other,self,"DIA_None_101_Mario_NeedGoodMen_15_00");   //Я всегда найду место для хороших людей.
        B_AI_Output(self,other,"DIA_None_101_Mario_NeedGoodMen_07_01");   //Конечно, увидимся на корабле.
...
{
        B_AI_Output(other,self,"DIA_Mario_LeaveMyShip_15_00");    //Я понял, что ты мне не нужен!
        B_AI_Output(self,other,"DIA_Mario_LeaveMyShip_07_01");    //Как скажешь. Ты знаешь, где искать меня!
...
{
        B_AI_Output(other,self,"DIA_Mario_StillNeedYou_15_00");   //Ты мне все-таки нужен!
        if(MARIO_ISONBOARD == LOG_OBSOLETE)
        {
                B_AI_Output(self,other,"DIA_Mario_StillNeedYou_07_01");   //Я знал! Увидимся на корабле!
                MARIO_ISONBOARD = LOG_SUCCESS;
                CREWMEMBER_COUNT = CREWMEMBER_COUNT + 1;
                AI_StopProcessInfos(self);
                if(MIS_READYFORCHAPTER6 == TRUE)
        ...
        {
                B_AI_Output(self,other,"DIA_Mario_StillNeedYou_07_02");   //Ты не смеешь так обращаться со мной. Плевать я на тебя хотел!
                AI_StopProcessInfos(self);
