...
func void dia_wirt_hallo_info()
{
        var int randy;
        randy = Hlp_Random(2);
        B_AI_Output(self,other,"DIA_Wirt_Hallo_14_00");   //Эй, не стесняйся, подходи. Отведай холодного пива.
        if(self.aivar[AIV_TALKEDTOPLAYER] == FALSE)
        {
                B_AI_Output(self,other,"DIA_Wirt_Hallo_14_01");   //Лорд Андрэ расщедрился на несколько бочек бесплатного пива.
                AI_StopProcessInfos(self);
        }
        else if(randy == 0)
        {
                B_AI_Output(self,other,"DIA_Wirt_Hallo_14_02");   //Нет ничего лучше, чем кружка холодного пива после работы.
                AI_StopProcessInfos(self);
        }
        else if(randy == 1)
        {
                B_AI_Output(self,other,"DIA_Wirt_Hallo_14_03");   //Паладины со всем разберутся сами. А ты можешь потягивать здесь пиво и наслаждаться жизнью.
                b_giveinvitems(self,other,itfo_beer,1);
                AI_StopProcessInfos(self);
        }
        else if(randy == 2)
        {
                B_AI_Output(self,other,"DIA_Wirt_Hallo_14_04");   //Можно говорить о Хоринисе что угодно, но наше 'Темное паладинское' бесспорно самое лучшее пиво во всей Миртане.
                AI_StopProcessInfos(self);
        };
};
