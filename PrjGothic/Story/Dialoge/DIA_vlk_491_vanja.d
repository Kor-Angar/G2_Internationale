...
{
        B_AI_Output(self,other,"DIA_Vanja_STANDARD_17_00");       //Я занята.
        AI_StopProcessInfos(self);
};
...
{
        B_AI_Output(other,self,"DIA_Vanja_DOPE_15_00");   //Где здесь можно купить травки?
        B_AI_Output(self,other,"DIA_Vanja_DOPE_17_01");   //Понятия не имею. Лучше не связывайся с этой дрянью.
        B_AI_Output(self,other,"DIA_Vanja_DOPE_17_02");   //К тому же, если ты будешь продолжать расспрашивать о ней, у тебя могут быть большие проблемы...
};
