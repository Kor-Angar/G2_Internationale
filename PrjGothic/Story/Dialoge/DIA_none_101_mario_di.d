...
{
        B_AI_Output(other,self,"DIA_NONE_101_MARIO_DI_Job_15_00");        //Тогда у тебя есть шанс показать свои боевые способности.
        B_AI_Output(self,other,"DIA_NONE_101_MARIO_DI_Job_07_01");        //Помедленнее. Всему свое время.
        B_AI_Output(other,self,"DIA_NONE_101_MARIO_DI_Job_15_02");        //Ммм. Я именно этого и ожидал от тебя.
        B_AI_Output(self,other,"DIA_NONE_101_MARIO_DI_Job_07_03");        //Подожди.
};
...
{
        B_AI_Output(self,other,"DIA_NONE_101_MARIO_DI_ambush_07_00");     //Подойди поближе. Так, мой друг. А теперь покажи мне, на что ты способен.
        B_AI_Output(other,self,"DIA_NONE_101_MARIO_DI_ambush_15_01");     //Что ты имеешь в виду?
        B_AI_Output(self,other,"DIA_NONE_101_MARIO_DI_ambush_07_02");     //Это просто. Хозяин уже устал от тебя.
        B_AI_Output(self,other,"DIA_NONE_101_MARIO_DI_ambush_07_03");     //Мне стоило убить тебя раньше. Но мои друзья и я сейчас исправим эту ошибку.
